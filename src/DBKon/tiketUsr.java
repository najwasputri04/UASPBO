 ...
 * @author asus
 */
public class tiketUsr extends javax.swing.JFrame {
    Koneksi kon;
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(tiketUsr.class.getName());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new tiketUsr().setVisible(true));
    }
